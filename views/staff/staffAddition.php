...
<html>
<head>
<title>Admin--Staff Addition</title>
<meta charset="utf-8" />
...
<body>
	  ...
	  <div class="modal-dialog modal-dialog-centered" role="document">
	    <div class="modal-content">
	      ...
	      <div class="modal-body text-center">
	        ...
	        <p><b>Make sure entered email or contact number is not associated with another user or staff.</b></p>
	      </div>
	...
	<div id="staffUpdateContainer" class="container d-flex flex-column justify-content-center w-50 p-2 bg-white shadow rounded p-0">
		...
		<form id="staffAddition" action="Staff/add" method="POST" class="d-flex flex-column justify-content-center align-item-center">
		  ...
		  <div class="form-group">
		    ...
		    <input type="text" class="form-control" id="staffAdd" name="sadd">
		    <small id="saddError" class=""></small>
		  </div>
		  <div class="form-group">
		    <label for="staffEmail">Staff Email</label>
		    <input type="text" class="form-control" id="staffEmail" name="semail">
		    <small id="semailError" class=""></small>
		  </div>
		  <div class="form-group">
		    <label for="staffContact">Staff Contact</label>
		    <input type="text" class="form-control" id="staffContact" name="scontact">
