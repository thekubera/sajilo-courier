...
<body>
	  ...
	  <div class="modal-dialog modal-dialog-centered" role="document">
	    <div class="modal-content">
	      ...
	      <div class="modal-body text-center">
	        ...
	        <p>Deleting branch will also <i class="text-danger">erase</i> the record of associated users and staffs. Make sure to mange or transfer it before deleting the branch.</p>
	      </div>
	      <div class="modal-footer">
	        <button type="button" class="btn btn-secondary" data-dismiss="modal">CANCEL</button>
	        <a id="delete-btn" href="Branch/delete" class="btn btn-danger text-white">DELETE</a>
	      </div>
	    </div>
	  </div>
	</div>
	...
	<div class="container d-flex flex-column shadow p-3 bg-white rounded">
		<div class="d-inline-flex justify-content-around">
			...
			<a href="<?= URLROOT;?>/Branch/addBranch" class="btn btn-success text-white mb-3">
				<i class="fas fa-plus"></i> New Branch
			</a>
		</div>

		<div id="branchInfo" class="table-responsive">
				    ...
				    <tr>
				      <?php 
				        ...
				        while( $row = $result->fetch_assoc()){ ?>
					      ...
					      <td>
					      	<a href="<?= URLROOT;?>/Branch/branchUpdate?id=<?php echo $row['bid'] ?>" class="btn btn-success ml-4">EDIT</a>
					      	<button value="<?php echo $row['bid']; ?>" class="btn btn-danger text-white delete" data-toggle="modal" data-target="#exampleModalCenter">DELETE</button>
					      </td>
				    </tr>
				    	<?php 
				    		$sn++;
			...
			$.ajax('Branch/delete', {
				...
				success: function(data) {
					if(data.trim() ===  "1") {
						...
						$(".modal-body").empty().append("<i class='fas fa-check-circle fa-5x text-success mb-4'></i><h2>Successfully branch details deleted.</h2>");
						$("#exampleModalCenter").prependTo("body");
						$('.modal-footer').hide();
